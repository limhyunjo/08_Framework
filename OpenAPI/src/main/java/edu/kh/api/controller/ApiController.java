...
public class ApiController {
	...
	@GetMapping("ex2")
	public String ex2(
			@RequestParam(value="regionName", required=false, defaultValue="서울")
			String regionName, Model model
			) throws IOException, JSONException {
		
		String serviceKey ="9p1AY7EhDSYQLjlaf2bdyHV+9ooK9iERT5cm8TSacJqPg3yXPJkyGOwkjmKVzeuCYkPDG0W/C3S5J+YfH1n9kQ==";
		...
		String[] arr = (sdf.format(new Date())).split("/"); // Date - java.util.date
		...
		// 주소?serviceKey=서비스키
	        ...
	        //응답 상태 코드(200 : 성공, 404: 페이지를 찾을 수 없음...)
