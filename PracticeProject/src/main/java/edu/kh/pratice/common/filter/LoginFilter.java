package edu.kh.pratice.common.filter;
 ...
 * [필터 클래스 생성 방법]
 * 
 * 1. jakarta.servlet.Filter 인터페이스 상속 받기 (tomcat 10버전 이상 == jakarta)
...
public class LoginFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// ServletResponse : HttpServletReponse의 부모 타입
		// 다운 캐스팅을 해야 쓸 수 있음
		...
		// 로그인이 되어있는 경우
			...
			chain.doFilter(request, response);  // filter가 만들어짐
		}
