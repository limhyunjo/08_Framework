...
@Transactional // 예외 발생하면 롤백( 기본 값이 커밋)
@Service // Bean 등록 , Service 역할 임을 명시
...
public class EmailServiceImpl implements EmailService{
	...
	// Mapper 의존성 주입
	private final EmailMapper mapper; // 자동으로 의존성 주임
