...
@RequestMapping("param") // 공통 주소 앞 부분 / /param으로 시작하는 요청을 
                                                                         // 현재 컨트롤러로 매핑
...
public class ParameterController {
	...
	@PostMapping("test3")
	public String paramTest3( // 여러개 얻어 올 때 defaultValue 못씀
		...
		// Map (K:V)  map은 키 값이 중복되면 덮어씌운다 
		log.debug("colorArr :" + Arrays.toString(colorArr)); // 배열 안의 값들이 한번에 보임
