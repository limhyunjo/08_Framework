...
@Controller // 요청 / 응답 제어 역할 임을 명시 + Bean 등록
...
public class ExampleController {
	 ...
	 *  - ModleAndView : 데이터 전달 + forward 할 파일 경로 지정
	 * */
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		// 단일 값(숫자, 문자열) Model을 이욯해서 html로 전달
		...
		stdList.add(new Student("111111", "김일번", 20));
	...
	public String ex2(Model model) {
		...
		// Model : 데이터 전달 용 객체 (request scope)
