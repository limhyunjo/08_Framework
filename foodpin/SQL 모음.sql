...
/*member02(사장회원), 멤버 코드 2 멤버 넘버 2 가게 넘버 1000112377 샘플*/
UPDATE "STORE" SET  
...
DELETE FROM "REVIEW" WHERE STORE_NO=1;
...
SELECT STORE_NAME, STORE_INFO, STORE_LOCATION, STORE_STATUS,
 ...
 STORE_CLOSED,STORE_IMG, TOTAL_RATING, MEMBER_NO 
   FROM "STORE" S
   JOIN STORE_CATEGORY SC ON S.STORE_NO = SC.STORE_NO
    JOIN WEEK_OFF W ON S.STORE_NO = W.STORE_NO
    JOIN DAY_OFF D ON S.STORE_NO = D.STORE_NO
    JOIN MENU M ON S.STORE_NO  = M.STORE_NO
 WHERE S.STORE_NO=1000112377;
